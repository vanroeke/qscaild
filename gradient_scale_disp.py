...
def prep_prepare_fit_3rd_weights(mat_rec_ac, mat_rec_ac_3rd, M, N, enforce_acoustic,
                            iteration_min):
    """
    New function to calculate to prepare the parallel run
    """
...
def disp_optimize_positions_weights(fcs, sposcar_file, iteration_min, weights,relax_amp):
    """
